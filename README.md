...
- Multiple AI frameworks support (PRPs, Context Engineering)
...
- 📚 **AI Frameworks** - PRPs, Context Engineering, Claudia GUI
...
### MCP Integrations
- **Docker MCP** - Control Docker through Claude
...
│   └── build-claudia.ps1  # Claudia build script
